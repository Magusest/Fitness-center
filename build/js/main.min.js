...
var _slider = require("./modules/sliders/slider");
var _video = require("./modules/video/video");
var _form2 = require("./modules/form/form");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var feedbackForm = document.querySelector('[data-form');
...
},{"./modules/form-validate/form":3,"./modules/form/form":9,"./modules/modals/init-modals":10,"./modules/sliders/slider":12,"./modules/tabs/init-tabs":13,"./modules/video/video":15,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
exports.initSuccessSend = initSuccessSend;
var feedbackForm = document.querySelector('[data-form');
var inputName = document.querySelector('[data-validate-type="text"]');
var inputPhone = document.querySelector('[data-validate-type="phone"]');
var modal = document.querySelector('[data-modal]');
function initSuccessSend() {
...
var trainersSwiper = document.querySelector('[data-slider="trainer"]');
var reviewSwiper = document.querySelector('[data-slider="review"]');
var initSlider = function initSlider() {
  if (trainersSwiper) {
    (function () {
      return new _swiper.default('.trainers__swiper', {
  ...
  if (reviewSwiper) {
    (function () {
      return new _swiper.default('.review__swiper', {
        direction: 'horizontal',
        slidesPerView: 1,
        navigation: {
...
},{"../../vendor/swiper":20}],13:[function(require,module,exports){
"use strict";
...
var targetVideo = '<iframe width="560" height="315" src="https://www.youtube.com/embed/9TZXsZItgdw?autoplay=1" title="YouTube video player" allow="autoplay" frameborder="0" allowfullscreen></iframe>';
function initVideo() {
  var videoContainer = document.querySelector('[data-video]');
